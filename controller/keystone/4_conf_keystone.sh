...
echo "==================================================================================="
echo " "
echo "WARNING! Please execute it with the user which load "
echo "'~/ostack-openrc/init-openrc' to his enviroment variable"
echo " "
...
register() {
  ...
  case "${OPT}" in
      ...
      y)  exit
          ;;
      N)  read -n1 -r -p "Create new domain on keystone as example domain. press ENTER to continue!" ENTER
